...
function BentoCard({ title, tools, icon, span }) {
  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          background: useMotionTemplate`radial-gradient(300px circle at ${mouseX}px ${mouseY}px, rgba(94, 106, 210, 0.15), transparent 80%)`,
        }}
      />
...
export default function SkillsBento() {
  return (
    <section className="relative z-10 container mx-auto py-20 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-8 max-w-5xl">
      <h2 className="mb-8 sm:mb-12 text-3xl sm:text-4xl font-semibold tracking-tight text-transparent bg-gradient-to-b from-white via-white/95 to-white/70 bg-clip-text">
        Technical Arsenal
      </h2>
